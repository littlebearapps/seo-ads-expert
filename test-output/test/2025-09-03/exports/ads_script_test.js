...
function main() {
  try {
    ...
    Logger.log('Total campaigns: 1');
    Logger.log('Total ad groups: 1');
    Logger.log('Total keywords: 1');
    Logger.log('=============================================');
...
function createCampaigns() {
  ...
  // Campaign: LBA_test_Test Cluster_AU
  try {
    Logger.log('Starting campaign creation: LBA_test_Test Cluster_AU');
    
    var campaign = AdsApp.newCampaignBuilder()
      .withName('LBA_test_Test Cluster_AU')
      .withStatus('PAUSED')
      .build()
      .getResult();
    ...
    var adGroup = createAdGroup(campaign, 'Test Cluster');
